...
Mi primer libro de HTML (en referencia al autor original) fue lanzado en 1997 y se llamaba *"HTML Unleashed"*. Un tomo largo, grande y de muchas páginas.

Mas de 20 años han pasado desde entonces y HTML es todavía la base de la web tal y como la conocemos hoy en día, con cambios mínimos desde entonces.
...
Resistió su transformación a un dialecto de XML por medio de XHTML, cuando, eventualmente, la gente se dio cuenta que era demasiado complejo.
...
Incluso sabemos cuál fue la primera página. Es esta: [http://info.cern.ch/hypertext/WWW/TheProject.html](https://info.cern.ch/hypertext/WWW/TheProject.html).
...
Aprendí mucho al escribirlo, a pesar de que llevo trabajando en la web más de 20 años y estoy seguro que usted también aprenderá algo nuevo.
